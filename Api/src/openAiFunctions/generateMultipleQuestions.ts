...
export const generateMultipleQuestions = async (fileId, botId ) => {
  try {
    ...
    const thread = await openai.beta.threads.create({
      messages: [
        {
          role: "user",
          content: `examina el documento, En base a 1 parrafo o explicacion concreta  de este documento genera 5  preguntas de opción múltiple basadas en texto 
                    3. Devuelve la pregunta y las respuestas en el siguiente formato JSON:
                    quizlet = {
                      Texto: "Parrafo elegido de donde se saco las 5 preguntas",
                      pregunta1: "Pregunta1",
                      respuestaNegativa1: "respuesta incorrecta 1",
                      respuestaNegativa2: "respuesta incorrecta 2",
                      respuestaPositiva1: "respuesta positiva",
                      pregunta2: "Pregunta2",
                      respuestaNegativa2: "respuesta incorrecta 1",
                      respuestaNegativa2: "respuesta incorrecta 2",
                      respuestaPositiva1: "respuesta positiva",
                      ...
                      respuestaPositiva1: "respuesta positiva",
                      pregunta1: "Pregunta1",
                      respuestaNegativa5: "respuesta incorrecta 1",
                      respuestaNegativa2: "respuesta incorrecta 2",
                      respuestaPositiva1: "respuesta positiva",
                    }
